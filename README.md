...
> [!IMPORTANT]  
> This widget version of GarminHomeAssistant is set to maintenance-only mode. That means, there will be only bug fixing for it. New features etc. will be only added to the [app/glance version](https://github.com/house-of-abbey/GarminHomeAssistant). The reason for this is described in the "Widget or Application?" section in this README.
